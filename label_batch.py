...
_LYNIS_CATEGORY_INTRO = {
    ...
    "Containers": "This is about container/virtualization settings on this device.",
    ...
    "LDAP": "This is about directory/authentication server settings.",
    ...
    "Shell": "This is about the command-line environment on this device.",
