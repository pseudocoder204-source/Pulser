...
Usage:
    python3 finetune/score_triage_eval.py
"""
...
_OUT_PATH = pathlib.Path(__file__).resolve().parent / "eval_triage_outputs.json"
_SCORES_PATH = pathlib.Path(__file__).resolve().parent / "eval_triage_scores.json"
